...
public class Build : EditorWindow
{
    ...
    static readonly string flutterSymbol = "FLUTTER_UNITY";

    bool pluginMode = false;
    static string persistentKey = "flutter-unity-widget-pluginMode";

    [MenuItem("💚 Flutter/Export Android %&p", false, 2)]
    ...
    [MenuItem("💚 Flutter/Export IOS %&o", false, 4)]
    ...
    private static void BuildIOS(String path)
    {
        try
        {
            ...
            PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.iOS, flutterSymbol);
            var report = BuildPipeline.BuildPlayer(playerOptions);
